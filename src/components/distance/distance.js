...
const Distance = () => {
    return (
        <div className="filter-section filter-section__distance">
            ...
            <input className="input" id="range-input" name="range-input" type="range" defaultValue="30" min="5" max="30" step="5" />
            ...
            <div className="distance-status">Current: <span>All</span> miles from <span>66204</span></div>
        </div>
    );
};
